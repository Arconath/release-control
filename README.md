...
SHA-256 of the transported OCI archive. Promotion and rollback manifests carry
that control SHA so GitOps can reject evidence generated by a superseded
publisher. Mutable tags are never accepted as source or deployment identity.
